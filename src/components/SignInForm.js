        ...
        <div className="w-full text-gray-800 antialiased px-4 py-20 flex flex-col justify-center box-border">
            ...
            <form className="py-2 px-4" onSubmit={(handleSubmit)}>
                ...
                <div className="w-full my-5">
                    <div><button className="block w-full h-10 bg-[#4285f4] font-semibold text-white rounded-md" onClick={signInWithGoogle}>Sign In With Google</button></div>
                    <button className="block w-full h-10 bg-[#292929] font-semibold text-white rounded-md" onClick={signInWithGit}>Sign In With GitHub</button>
                </div>
            </form>
        </div>
    );
